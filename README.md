---
website: "Entidade do Tesouro e Finanças"          # Entre as aspas escreve o nome do website
date: "26/05/2026"                    # Entre as aspas escreve a data de criação do 1º relatório. Os restantes estão no histórico
uri: "https://www.etf.gov.pt"   # Entre as aspas escreve o domínio do website
a11y_statement: "https://www.etf.gov.pt/acessibilidade" # Entre as aspas escreve o URL da Declaração de Acessibilidade do website
owner: "Entidade do Tesouro e Finanças"         # Entre as aspas escrever o nome do owner do website
...
<details>
  ...
  <ul aria-label="lista de relatórios já efetuados">
    <li><a href="26052026_report.html">(26/05/2026). Relatório {{ page.website }}</a></li>
  </ul>
</details>
